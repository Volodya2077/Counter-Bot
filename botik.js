...
bot.on('text', (ctx) => {
    ...
    if (action){
        ...
        if (!isNaN(input)) {
            ...
            switch (action) {
                case 'Обувь👟':
                    response = `Сумма заказа с учётом доставки и страховки до Москвы: ${Math.floor(((input *13.6)+850+350))*0.1<500? Math.floor(((input *13.6)+850+350))+500:Math.floor(((input *13.6)+850+350)*1.1)}₽
...
По поводу авиа доставки🛩️  писать - @AstanakX
                ...
                case 'Штаны/Толстовки👖':
                    response = `Сумма заказа с учётом доставки и страховки до Москвы: ${Math.floor(((input *13.6)+650+150)*0.1<500?Math.floor(((input *13.6)+650+150)+500):Math.floor(((input *13.6)+650+150)*1.1))}₽
...
По поводу авиа доставки🛩️  писать - @AstanakX
                    ...
                    break;
                case 'Шорты/футболки👕':
                    response = `Сумма заказа с учётом доставки и страховки до Москвы: ${Math.floor(((input *13.6)+500+150)*0.1)<500?Math.floor(((input *13.6)+500+150)+500):Math.floor(((input *13.6)+500+150)*1.12)}₽
...
По поводу авиа доставки🛩️  писать - @AstanakX
                    ...
                    break;
                case 'Куртки🏂':
                    response = `Сумма заказа с учётом доставки и страховки до Москвы: ${Math.floor(((input *13.6)+700+150)*0.1)<500?Math.floor(((input *13.6)+700+150)+500):Math.floor(((input *13.6)+700+150)*1.1)}₽
...
По поводу авиа доставки🛩️  писать - @AstanakX`
                case 'Аксессуары⌚️':
                    response = `Сумма заказа с учётом доставки и страховки до Москвы: ${Math.floor(((input *13.6)+550+250)*0.1)<500?Math.floor(((input *13.6)+550+250)+500):Math.floor(((input *13.6)+550+250)*1.1)}₽
